...
本检查点已分诊 **45/93** 条：dispatch 7，note-only 28，drop 10；文献 open 30，published 9，unknown 6。 尚未列出的条目仍在查证，不能视为已淘汰。
