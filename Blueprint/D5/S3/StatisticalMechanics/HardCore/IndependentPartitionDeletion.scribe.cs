    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-independent-configurations"),
                ...
                H("Actual independent configurations"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-weighted-partition"),
                ...
                H("Multivariate partition sum"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-closed-complement"),
                ...
                H("Delete the closed neighborhood"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-partition-delete"),
                ...
                H("Denominator-free deletion identity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-partition-empty"),
                ...
                H("Empty-domain normalization"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-map-partition"),
                ...
                H("Scalar evaluation preserves configurations"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-independence-polynomial"),
                ...
                H("The independence polynomial"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-independence-polynomial-eval"),
                ...
                H("Complex evaluation is the actual partition"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-one-le-partition"),
                ...
                H("Nonnegative real activities"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
