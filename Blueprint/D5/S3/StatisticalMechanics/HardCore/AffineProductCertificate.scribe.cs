    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-clipped-product-bound"),
                ...
                H("A global product bound from a clamped witness"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-clip-witness"),
                ...
                H("Rational proposal data"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-checked-affine-row"),
                ...
                H("Exact finite certificate obligations"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-checked-affine-row-sound"),
                ...
                H("Every real point and every smaller activity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
