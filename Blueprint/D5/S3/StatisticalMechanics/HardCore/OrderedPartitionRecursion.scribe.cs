    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-after-erases"),
                ...
                H("Successive actual vertex deletions"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-deletion-numerator-product"),
                ...
                H("Vacant numerator factors"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-deletion-denominator-product"),
                ...
                H("Pre-deletion denominator factors"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-vacancy-product"),
                ...
                H("Ordered product of actual vacancy ratios"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-after-erases-set"),
                ...
                H("Final-domain set identity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-telescoping-cross"),
                ...
                H("Telescoping without division"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-after-erases-neighbors"),
                ...
                H("Actual closed-neighborhood domain"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-ordered-partition-cross"),
                ...
                H("The polynomial recurrence at every activity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-partition-ordered-recursion"),
                ...
                H("Derived ratio recursion on proper domains"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-local-denominator-nonvanishing"),
                ...
                H("Noncircular nonvanishing propagation"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
