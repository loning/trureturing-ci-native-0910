    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("adaptive-r4-mask"),
                ...
                H("Actual blocked vertices"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-choice"),
                ...
                H("Selected local order"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-step"),
                ...
                H("Geometrically computed successor"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-weight"),
                ...
                H("Integer super-potential"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-geometry"),
                ...
                H("Complete selected geometric closure"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-potential"),
                ...
                H("Exact row inequalities"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-count-upper"),
                ...
                H("All states and depths"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-domain-upper"),
                ...
                H("Uniform actual-domain bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-parent-domain-upper"),
                ...
                H("Parent-deleted domains"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-root-direction"),
                ...
                H("Four root directions"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-root-domain"),
                ...
                H("Actual root branch domain"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-root-count"),
                ...
                H("Full root deletion count"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("adaptive-r4-root-upper"),
                ...
                H("Uniform four-neighbor root bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
