    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-grid-partition-occupation-identity"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.grid_partition_occupation_identity"),
                H("grid partition occupation identity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-normalized-log-first-moment"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.normalized_log_first_moment"),
                H("normalized log first moment"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-normalized-log-occupation-identity"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.normalized_log_occupation_identity"),
                H("normalized log occupation identity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-normalized-log-scaled-response-bound"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.normalized_log_scaled_response_bound"),
                H("normalized log scaled response bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-real-gibbs-log-derivative"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.real_gibbs_log_derivative"),
                H("real Gibbs log derivative"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-occupation-occupationresponse-gibbs-expected-card-is-log-response"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse.gibbs_expected_card_is_log_response"),
                H("Gibbs expected card is log response"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
