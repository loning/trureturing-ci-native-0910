    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-holo-invarianttube-row-at-centers"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/InvariantTube.row_at_centers"),
                H("row at centers"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-holo-invarianttube-jacobian-tube-sum"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/InvariantTube.jacobian_tube_sum"),
                H("jacobian tube sum"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-holo-invarianttube-row-tube-stability"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/InvariantTube.row_tube_stability"),
                H("row tube stability"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
