    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-partition-control"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_partition_control"),
                H("finite grid partition control"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-partition-lower"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_partition_lower"),
                H("finite grid partition lower"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-zero-free"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_zero_free"),
                H("finite grid zero free"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-zero-free-explicit"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_zero_free_explicit"),
                H("finite grid zero free explicit"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-independencePolynomial-zero-free"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_independencePolynomial_zero_free"),
                H("finite grid independencePolynomial zero free"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-origin-increment"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_origin_increment"),
                H("finite grid origin increment"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-final-finitegridzerofree-finite-grid-vacancy-bound"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/FiniteGridZeroFree.finite_grid_vacancy_bound"),
                H("finite grid vacancy bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
