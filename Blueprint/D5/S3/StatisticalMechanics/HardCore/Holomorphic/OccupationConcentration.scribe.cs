...
internal sealed class OccupationConcentrationDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-densityMeanSquare"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.densityMeanSquare"),
                H("densityMeanSquare"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-density-mean-square-eq"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.density_mean_square_eq"),
                H("density mean square eq"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-grid-density-mean-square-bound"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.grid_density_mean_square_bound"),
                H("grid density mean square bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-densityDeviationMass"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.densityDeviationMass"),
                H("densityDeviationMass"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-density-deviation-mass-bounds"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.density_deviation_mass_bounds"),
                H("density deviation mass bounds"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-density-deviation-le-second-moment"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.density_deviation_le_second_moment"),
                H("density deviation le second moment"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-variance-occupationconcentration-grid-density-deviation-bound"),
                DeclarationHandle.Create("D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration.grid_density_deviation_bound"),
                H("grid density deviation bound"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
