    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("hc-partition-domain-monotonicity"),
                ...
                H("Nonnegative domain monotonicity"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-actual-vacancy-ratio"),
                ...
                H("Vacancy as an actual ratio"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-actual-vacancy-bounds"),
                ...
                H("Derived invariant real interval"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-actual-real-ordered-vacancy"),
                ...
                H("The actual reciprocal recursion"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(DescribeId.Create("hc-actual-real-255-message-box"),
                ...
                H("The exact box at activity 2.55"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
