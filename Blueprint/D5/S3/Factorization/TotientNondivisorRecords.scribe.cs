        ...
        Blocks(
            ...
            Paragraph(Text(
                "The counterexample and range theorem share the functions a and L, so they "
                    + "are placed in one module. Natural subtraction is truncated. A sum over "
                    + "0 <= j < k is the Finset.range k sum, and the lcm over an empty range is one.")),
            ...
            Entry("powerSum", "power-sum", "Finite power sum",
                ...
                "The range contains precisely 0 through k-1. At the positive exponent used "
                    + "below, the added zeroth term vanishes, leaving the OEIS sum from 1 to k-1.",
                AssessedProvenance.FromRepo()),
            ...
            Entry("A095366", "a095366", "Least power-sum divisor",
                ...
                "This is Nat.sInf of exactly the natural numbers satisfying PowerSumDivisor. "
                    + "It formalizes the A095366 definition cited by OEIS A378640 (Xausa, 2024); "
            ...
            Entry("A095366_1275120_ne_51", "a095366-1275120-not-51",
                ...
                "Kernel-producing modular reduction gives powerSum(1275120,51) congruent to "
                    + "31 modulo 51, while the corresponding sum at 53 is congruent to zero. "
                    + "Hence 53 inhabits the defining set but 51 does not.",
                AssessedProvenance.FromRepo()),
