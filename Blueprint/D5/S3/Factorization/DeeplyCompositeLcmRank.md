...
DC(n) means that n is positive and DivPlusPrecedes(n,m) holds for every positive m below n. This is shared vocabulary with the sibling deeply-composite lanes.
