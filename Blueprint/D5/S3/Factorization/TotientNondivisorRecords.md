...
$$\forall N \in \mathbb{N}, k \in \mathbb{N},\; (1 \le N) \Rightarrow (\operatorname{powerSum}\left(N, k\right) = \sum_{{1 \le j < k}} j^{N})$$
...
$$\forall N \in \mathbb{N},\; (1 \le N) \Rightarrow (\operatorname{A095366}\left(N\right) = \operatorname{sInf}\left(\{k: \mathbb{N} \mid (1 < k \land k \mid \sum_{{1 \le j < k}} j^{N})\}\right))$$
