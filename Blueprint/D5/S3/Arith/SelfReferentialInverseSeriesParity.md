...
Paul D. Hanna's OEIS A393170 entry defines an integer series A by requiring coefficient n of the reciprocal of A-nX to vanish at every positive n, and states the parity conjecture.
...
**Theorem 1.2 (The normalized quadratic root is unique).**
...
**Theorem 1.3 (Identification with the Artin series).**
...
**Theorem 1.4 (Support of the constant-one root).**
...
**Theorem 1.5 (The A393170 parity conjecture).**
