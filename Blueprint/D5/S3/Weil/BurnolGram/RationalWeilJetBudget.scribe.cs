...
{
    private const string Prefix = "D5/S3/Weil/BurnolGram/RationalWeilJetBudget.";
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(DescribeId.Create("rational-weil-head-rational-spectral-head"),
            ...
            Describe.Lean(DescribeId.Create("rational-weil-head-fourth-moment-summand-le-rational-enclosure"),
            ...
            Describe.Lean(DescribeId.Create("rational-weil-head-rational-spectral-head-sound"),
            ...
            Describe.Lean(DescribeId.Create("rationalweiljetbudget-rational-jet-majorant"),
            ...
            Describe.Lean(DescribeId.Create("rationalweiljetbudget-rational-jet-majorant-sound"),
