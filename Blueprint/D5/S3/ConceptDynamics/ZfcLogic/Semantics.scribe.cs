...
internal sealed class SemanticsDocument : IScribeDocumentDefinition
{
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        H("Semantics"),
        Blocks(
            Paragraph(Text("Source-command excerpt selected from Foundation.Logic.Semantics, lines 1-363, at Foundation revision 30a16ffa93d79d73ab4d02427fa00f50e039bf29. Only commands with live proof or source-elaboration consumers for the Kuratowski pair extension are retained.")),
