...
internal sealed class NonfairMediationEnclosureDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Paragraph(Text("All theorem statements are projected from their bound Lean declarations. The original mediator and outcome probability-law semantics are retained. No compilation or independent review status is asserted by this source document.")),
