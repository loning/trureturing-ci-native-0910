    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            Describe.Lean(
                ...
                H("Arithmetic expression with proposed endpoints"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Proposed rational bounds"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Real evaluation independent of annotations"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Exact local rational checks"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
            ...
            Describe.Lean(
                ...
                H("Successful checks enclose every real input"), StatementSource.FromLean(), AssessedProvenance.FromRepo(),
