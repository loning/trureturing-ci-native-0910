...
{
    private const string Prefix = "D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.";
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Node("a392208-first-derivative", "exp_definition_derivative_zero",
                ...
                "Evaluating the exponential equation from OEIS A392208 (2026-01-24) at constant coefficient "
                    + "zero derives A'(0)=1; this value is not an added hypothesis.",
                AssessedProvenance.FromRepo(), DescribeRole.Theorem),
            ...
            Node("a392208-parity-conjecture", "a392208_parity_conjecture",
                ...
                "This is the whole conjecture stated by OEIS A392208 (2026-01-24): for every positive index, "
                    + "the coefficient is even if and only if three divides the index. The live proof path is "
                    + "the OEIS equation, its differentiated ODE, recurrence uniqueness, characteristic-two "
