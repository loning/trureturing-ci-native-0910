        ...
        Blocks(
            Describe.Lean(
                ...
                Blocks(Paragraph(Text(
                    "Proof shape: content (definition). N is formula (2)'s literal factored "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content (definition). D is formula (2)'s literal squared "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only normalization; simp unfolds D and ring gives the "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only normalization; simp unfolds N and ring gives the "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content (definition). The sequence a is defined by the "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; linear normalization of the private recurrence "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; norm_num substitutes the eight private base-value "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; coefficient extensionality and the private coefficient "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; power-series inversion rewrites the product identity, "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; the private coefficient kernel and strong induction "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; casting the private integer recurrence kernel to "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; two shifted reduced recurrences cancel in "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; period ten reduces every n to the private initial-parity "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; coefficients_unique rewrites the sequence and the "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; modular arithmetic projects the first OEIS "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; modular arithmetic projects the second OEIS "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; coefficients_unique rewrites b to a, then the first "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: bind-only; coefficients_unique rewrites b to a, then the second "
                        + "non-generating-function evenness companion applies. Directed edges "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content (definition). OEIS A396093 states B(x)=x/(1-x)^2. "
            ...
            Describe.Lean(
                ...
                AssessedProvenance.FromRepo(),
                Blocks(Paragraph(Text(
                    "Proof shape: content; the proof establishes the required nonzero denominator "
