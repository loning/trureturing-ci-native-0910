...
**Theorem 1.2 (Integer subtraction is equivalent to the additive exclusion test).**
...
**Theorem 1.3 (The literal and additive sequence rules are identical).**
...
**Theorem 1.4 (The protected residue class cannot be excluded).**
...
**Theorem 1.5 (Five ordered witness families cover the complement).**
...
**Definition 1.6 (Well-founded Nat.find realization).**
...
**Theorem 1.7 (The recursive sequence satisfies the literal rule).**
...
**Theorem 1.8 (The initial term is one).**
...
**Theorem 1.9 (The second term is three).**
...
**Theorem 1.10 (Every later term is the least literal admissible value).**
...
**Theorem 1.11 (The literal-rule sequence exists uniquely).**
...
**Theorem 1.12 (OEIS A026488 has the exact formula 1, 3, then 3n-5).**
