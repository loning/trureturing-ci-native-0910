...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfMul` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfPow` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.recurrenceRhs` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.table` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.initial_residues_mod_two` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a_recurrence` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.recurrence_coefficient_period_three` (`✓ std3`). ∎
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.ExpDefines` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.exp_definition_implies_ode` (`✓ std3`). ∎
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfSeries` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.exp_definition_derivative_zero` (`✓ std3`). ∎

*Source.* Repository-derived.

*Commentary.*

Evaluating the exponential equation from OEIS A392208 (2026-01-24) at constant coefficient zero derives A'(0)=1; this value is not an added hypothesis.
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.EgfOde` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfOde_unique` (`✓ std3`). ∎
...
*Formalization.* `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.OEISDefines` (`✓ std3`).
...
**Theorem 1.16 (The OEIS equation determines the recurrence sequence).**

$$\forall s: (\mathbb{N} \to \mathbb{Z}), (\operatorname{OEISDefines}\left(s\right)) \Rightarrow s = a$$

*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.oeis_defined_eq_recurrence` (`✓ std3`). ∎
...
**Theorem 1.17 (Every OEIS-defined sequence has period three modulo two).**
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.oeis_coefficient_period_three` (`✓ std3`). ∎
...
**Theorem 1.18 (The A392208 parity conjecture).**
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a392208_parity_conjecture` (`✓ std3`). ∎

*Source.* Repository-derived.

*Commentary.*

This is the whole conjecture stated by OEIS A392208 (2026-01-24): for every positive index, the coefficient is even if and only if three divides the index. The live proof path is the OEIS equation, its differentiated ODE, recurrence uniqueness, characteristic-two period three, and the initial residue pattern 0,1,1.

## References

- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.EgfOde`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.ExpDefines`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.OEISDefines`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a392208_parity_conjecture`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.a_recurrence`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfMul`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfOde_unique`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfPow`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.egfSeries`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.exp_definition_derivative_zero`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.exp_definition_implies_ode`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.initial_residues_mod_two`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.oeis_coefficient_period_three`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.oeis_defined_eq_recurrence`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.recurrenceRhs`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.recurrence_coefficient_period_three`
- Truth anchor: `D5/S1/Recurrence/ExponentialImplicitParityPeriodThree.table`
