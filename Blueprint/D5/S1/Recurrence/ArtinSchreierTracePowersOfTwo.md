...
*Formalization.* `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.a` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.prefixPolynomial` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.prefixPolynomial_eq_sum` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.source_equation` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.normalized_solution_unique` (`✓ std3`). ∎
...
*Formalization.* `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinCoeff` (`✓ std3`).
...
*Formalization.* `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinSeries` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinSeries_square_add` (`✓ std3`). ∎
...
*Formalization.* `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly_identity` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly_natDegree_le` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.coeff_artinSeries_pow_eq_zero` (`✓ std3`). ∎

*Source.* Repository-derived.

*Commentary.*

If floor(m/2)<n<m, coefficient n of S^m is zero. The degree bound kills coefficient n of T_m, while S+1 has zero constant coefficient and therefore its mth power has no coefficient below m. This is the live Artin-Schreier trace escape witness.
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.reducedSeries_eq_artinSeries` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.a396808_first_conjecture` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.a`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.a396808_first_conjecture`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinCoeff`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinSeries`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.artinSeries_square_add`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.coeff_artinSeries_pow_eq_zero`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.normalized_solution_unique`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.prefixPolynomial`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.prefixPolynomial_eq_sum`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.reducedSeries_eq_artinSeries`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.source_equation`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly_identity`
- Truth anchor: `D5/S1/Recurrence/ArtinSchreierTracePowersOfTwo.tracePoly_natDegree_le`
