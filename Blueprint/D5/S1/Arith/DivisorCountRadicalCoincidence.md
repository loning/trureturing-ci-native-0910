...
*Proof.* Machine-checked in Lean as `D5/S1/Arith/DivisorCountRadicalCoincidence.radical_eq_card_divisors_of_dvd` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Arith/DivisorCountRadicalCoincidence.radical_eq_card_divisors_of_dvd`
