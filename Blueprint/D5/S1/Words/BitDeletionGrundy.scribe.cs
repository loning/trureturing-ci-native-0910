...
internal sealed class BitDeletionGrundyDocument : IScribeDocumentDefinition
{
    ...
    public DocumentDefinition Create() => DocumentDefinition.Create(ScribeNode.Create(
        ...
        Blocks(
            ...
            Definition(
                ...
                AssessedProvenance.FromRepo(),
                "The public witness map T_0 sends state value 1 to 3 and every other value "
                    + "in Fin 4 to 1."),
            Definition(
                "transition1", "odd-suffix-transition", "The odd-suffix transition",
                Transition1Definition(),
                AssessedProvenance.FromRepo(),
                "The public witness map T_1 sends state value 0 to 2 and every other value "
                    + "in Fin 4 to 0."),
            Definition(
            ...
            Theorem(
                "g_eq_wordGrundy", "natural-word-bridge",
                "The natural game is the canonical word game",
                GEqualsWordGrundy(),
                AssessedProvenance.FromRepo(),
    ...
    {
        Formula b = F.Id("b"), w = F.Id("w"), v = F.Id("v");
