...
$$(\operatorname{erasures}([]) = []) \land (\forall b: Bool, \forall w: List Bool, \operatorname{erasures}(\operatorname{cons}(b, w)) = \operatorname{cons}(w, \operatorname{map}((v \mapsto \operatorname{cons}(b, v)), \operatorname{erasures}(w))))$$
