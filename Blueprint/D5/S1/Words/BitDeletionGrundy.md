...
**Theorem 1.16 (The natural game is the canonical word game).**
...
**Theorem 1.17 (The natural-number mex recurrence).**
...
**Theorem 1.18 (The zero boundary value).**
...
**Theorem 1.19 (No Grundy value exceeds three).**
...
**Theorem 1.20 (Multiplication by four preserves the value).**
...
**Theorem 1.21 (Both OEIS A398916 conjectures).**
