...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.SignedPerm` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.Generator` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.simple0` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.simple1` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.evalWord` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.IsReducedWord` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.TwoBoolean` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.longest` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.mirrorValue` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.valueAt` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.OrderIsomorphic` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.GloballyContains` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern3421` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern4312` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern4321` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern456123` (`✓ std3`).
...
*Formalization.* `D5/S1/Words/TwoBooleanPersistenceRefutation.AvoidsTwoBooleanPatterns` (`✓ std3`).
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/TwoBooleanPersistenceRefutation.reduced_words_longest_iff` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/TwoBooleanPersistenceRefutation.longest_twoBoolean` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/TwoBooleanPersistenceRefutation.longest_globallyContains_4321` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/TwoBooleanPersistenceRefutation.twoBoolean_persistence_refutation` (`✓ std3`). ∎
...
*Proof.* Machine-checked in Lean as `D5/S1/Words/TwoBooleanPersistenceRefutation.twoBoolean_set_differs_from_global_avoiders` (`✓ std3`). ∎
...
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.AvoidsTwoBooleanPatterns`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.Generator`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.GloballyContains`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.IsReducedWord`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.OrderIsomorphic`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.SignedPerm`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.TwoBoolean`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.evalWord`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.longest`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.longest_globallyContains_4321`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.longest_twoBoolean`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.mirrorValue`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern3421`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern4312`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern4321`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.pattern456123`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.reduced_words_longest_iff`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.simple0`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.simple1`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.twoBoolean_persistence_refutation`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.twoBoolean_set_differs_from_global_avoiders`
- Truth anchor: `D5/S1/Words/TwoBooleanPersistenceRefutation.valueAt`
