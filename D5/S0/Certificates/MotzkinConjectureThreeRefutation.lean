...
The only included declarations are claim and result. The finite tables and
elimination data below are private. They certify a NEW numerical obstruction
...
imported; the private certificate is checked by the kernel.
-/
...
@[local simp] private theorem power_zero (n : ℕ) :
    convolutionPower 0 n = if n = 0 then 1 else 0 := rfl

@[local simp] private theorem catalan_value_4 : catalan 4 = 14 := by decide +kernel
@[local simp] private theorem catalan_value_5 : catalan 5 = 42 := by decide +kernel
@[local simp] private theorem catalan_value_6 : catalan 6 = 132 := by decide +kernel
@[local simp] private theorem catalan_value_7 : catalan 7 = 429 := by decide +kernel
@[local simp] private theorem catalan_value_8 : catalan 8 = 1430 := by decide +kernel

set_option maxHeartbeats 4000000 in
-- Normalize the seventeen finite Motzkin sums in this single certificate.
@[local simp] private theorem motzkin_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_1_values (n : ℕ) (hn : n < 17) :
    convolutionPower 1 n = ([1, 1, 2, 4, 9, 21, 51, 127, 323, 835, 2188, 5798, 15511, 41835,
      113634, 310572, 853467] : List ℤ).getD n 0 := by
  interval_cases n <;> rw [convolutionPower] <;> norm_num [Finset.sum_range_succ]

set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_2_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_3_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_4_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_5_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_6_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_7_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_8_values (n : ℕ) (hn : n < 17) :
...
set_option maxHeartbeats 4000000 in
-- Normalize seventeen finite Cauchy products using the preceding prefix.
@[local simp] private theorem power_9_values (n : ℕ) (hn : n < 17) :
...
private def sample : Matrix (Fin 9) (Fin 9) ℤ :=
...
private def lower : Matrix (Fin 9) (Fin 9) ℤ :=
  !![1, 0, 0, 0, 0, 0, 0, 0, 0;
    -9, 1, 0, 0, 0, 0, 0, 0, 0;
...
private def upper : Matrix (Fin 9) (Fin 9) ℤ :=
...
set_option maxHeartbeats 4000000 in
-- The kernel checks a nine-dimensional integer matrix product and its triangular factors.
...
theorem result : ¬ claim := by
  ...
  have lower_times_sample : lower * sample = upper := by decide +kernel
  have lower_triangular : lower.IsLowerTriangular := by decide +kernel
  have upper_triangular : upper.IsUpperTriangular := by decide +kernel
