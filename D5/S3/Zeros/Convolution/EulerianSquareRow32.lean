...
private theorem row_1 : row 1 =
  [0, 1] := by
  rw [row]
  simp only [row_0]
  decide

private theorem row_2 : row 2 =
  [0, 1, 1] := by
  rw [row]
  simp only [row_1]
  decide

private theorem row_3 : row 3 =
  [0, 1, 4, 1] := by
  rw [row]
  simp only [row_2]
  decide

private theorem row_4 : row 4 =
  [0, 1, 11, 11, 1] := by
  rw [row]
  simp only [row_3]
  decide

private theorem row_5 : row 5 =
  [0, 1, 26, 66, 26, 1] := by
  rw [row]
  simp only [row_4]
  decide

private theorem row_6 : row 6 =
  [0, 1, 57, 302, 302, 57, 1] := by
  rw [row]
  simp only [row_5]
  decide

private theorem row_7 : row 7 =
  [0, 1, 120, 1191, 2416, 1191, 120, 1] := by
  rw [row]
  simp only [row_6]
  decide

private theorem row_8 : row 8 =
  [0, 1, 247, 4293, 15619, 15619, 4293, 247, 1] := by
  rw [row]
  simp only [row_7]
  decide

private theorem row_9 : row 9 =
  [0, 1, 502, 14608, 88234, 156190, 88234, 14608, 502, 1] := by
  rw [row]
  simp only [row_8]
  decide

private theorem row_10 : row 10 =
  [0, 1, 1013, 47840, 455192, 1310354, 1310354, 455192, 47840, 1013, 1] := by
  rw [row]
  simp only [row_9]
  decide

private theorem row_11 : row 11 =
  [0, 1, 2036, 152637, 2203488, 9738114, 15724248, 9738114, 2203488, 152637, 2036, 1] := by
  rw [row]
  simp only [row_10]
  decide

private theorem row_12 : row 12 =
