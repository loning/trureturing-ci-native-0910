/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/TypedJacobian
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/TypedJacobian
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.AffineChart

set_option autoImplicit false
set_option relaxedAutoImplicit false

noncomputable section
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.TypedJacobian
...
theorem rowMap_differentiableAt [Fintype ι] (s : Finset ι)
  ...
  have hh : DifferentiableAt ℂ
    ...
    dsimp [logArgument]
    fun_prop
  exact (hh.clog hH).neg.div_const b0
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.TypedJacobian
