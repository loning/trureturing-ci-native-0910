/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationConcentration
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.LinearVolumeVariance

set_option autoImplicit false
set_option relaxedAutoImplicit false

noncomputable section
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.OccupationConcentration
...
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.LinearVolumeVariance
...
theorem grid_density_mean_square_bound (V : Finset Point) (hV : V.Nonempty)
  ...
  calc
    ...
    _ = _ := by field_simp [ne_of_gt hn]; ring
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.OccupationConcentration
