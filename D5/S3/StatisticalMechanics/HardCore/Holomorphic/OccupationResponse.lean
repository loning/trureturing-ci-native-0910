/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/OccupationResponse
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.NormalizedPartitionLog

set_option autoImplicit false
set_option relaxedAutoImplicit false

noncomputable section
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.OccupationResponse
...
private theorem real_activity_mem (lam : ℝ) (hlam : 0 ≤ lam ∧ lam ≤ 51 / 20) :
  ...
  refine ⟨lam, hlam, ?_⟩
  simpa using D5.S3.StatisticalMechanics.HardCore.Holomorphic.TubeEstimates.width_arithmetic.2.1
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.OccupationResponse
