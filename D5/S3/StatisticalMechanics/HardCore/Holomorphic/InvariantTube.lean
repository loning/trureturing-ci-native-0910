/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/InvariantTube
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/InvariantTube
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.RowTubeBounds
...
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.InvariantTube
...
theorem row_tube_stability (s : Finset ι) (hs : s.card ≤ 4)
  ...
  have hf (t:ℝ) (ht : t ∈ Set.Icc (0:ℝ) 1) :
    ...
    have h := rowMap_hasDerivAt s a0 b0 (fun j => a j) (fun j => b j) zt mt t dz dm hb0
      ...
      (fun j _ => by simpa [mt] using ((hasDerivAt_id (t:ℂ)).mul_const (dm j)).const_add
  ...
  have hdf (t:ℝ) (ht : t ∈ Set.Icc (0:ℝ) 1) :
    ...
    calc
      _ ≤ ‖activityEntry s a0 b0 (fun j => a j) (fun j => b j) (zt t) (fun j => mt j t)‖*‖dz‖+
        ...
        (norm_add_le _ _).trans (add_le_add (by rw [norm_mul]) (by simpa [norm_mul] using norm_sum_le s _))
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.InvariantTube
