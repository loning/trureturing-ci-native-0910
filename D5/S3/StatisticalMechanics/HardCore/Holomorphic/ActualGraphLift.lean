/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/ActualGraphLift
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/ActualGraphLift
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.AdaptiveComplexNeighborhood

set_option autoImplicit false
set_option relaxedAutoImplicit false

noncomputable section
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.ActualGraphLift
...
theorem neutral_message (i : Fin 881) :
  ...
  · exact inverse_center _ _ 1 (by linarith [hc.1, hc.2.1])
      (by norm_num) (by simpa using lt_of_lt_of_le (by norm_num) hc.2.1)
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.ActualGraphLift
