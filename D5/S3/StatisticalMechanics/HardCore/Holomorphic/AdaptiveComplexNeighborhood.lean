/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/AdaptiveComplexNeighborhood
   generality: S
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/AdaptiveComplexNeighborhood
...
import D5.S3.StatisticalMechanics.HardCore.Holomorphic.InvariantTube
...
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.AdaptiveComplexNeighborhood
open scoped BigOperators
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.AffineChart
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.TypedJacobian
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.TubeEstimates
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.RowTubeBounds
open D5.S3.StatisticalMechanics.HardCore.Holomorphic.InvariantTube
...
theorem actual_coefficient_bounds (i : Fin 881) : CoeffBound (aa i) (bb i) := by
  ...
  have ha : (0:ℝ) ≤ aa i := by exact_mod_cast h.1
  have hc : (10577/1000000:ℝ) ≤ bb i-aa i := by exact_mod_cast h.2.1
  have hb' : bb i ≤ (3:ℝ) := by exact_mod_cast hb i
...
private theorem real_row (i : Fin 881) (s : Finset (Fin 3)) (hs : Pruning i s)
  ...
  have hxmask : (fun d => if d ∈ s then x d else 1) = x := by funext d; simp [x]
  ...
  have heq : (∑ d ∈ s, ‖((-(lam*P*(bb (childType i d)-aa (childType i d)*r d)) /
    ...
    calc
      ...
      _ = _ := by
        ...
        dsimp [affineMessage,aa,bb,vacancy] at *
        rw [hp]
        field_simp [hD,ne_of_gt hH] <;> ring
  rw [heq]
  exact hrow.le
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.AdaptiveComplexNeighborhood
