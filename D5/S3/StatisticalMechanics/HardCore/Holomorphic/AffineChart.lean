/- GID: D5/S3/StatisticalMechanics/HardCore/Holomorphic/AffineChart
   generality: G
   mirror-B: D5/B/S3/StatisticalMechanics/HardCore/Holomorphic/AffineChart
...
namespace D5.S3.StatisticalMechanics.HardCore.Holomorphic.AffineChart
...
theorem inverse_hasDerivAt (a b m : ℂ)
  ...
  convert h using 1 <;> dsimp [inverse, psi] <;> field_simp [hd] <;> ring
...
theorem chart_hasDerivAt (a b x : ℂ) (hb : b ≠ 0) (hx : x ≠ 0)
  ...
  convert h using 1 <;> dsimp [chart, psi] <;> field_simp [hb, hx, hh, hp] <;> ring
...
end D5.S3.StatisticalMechanics.HardCore.Holomorphic.AffineChart
