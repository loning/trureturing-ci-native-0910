...
public sealed class RuleCatalogAssociationTests
{
    ...
    public void ExecuteStampsAUniqueFindingWithItsPairedDescriptorAcrossACompleteCatalog()
    {
        ...
        var registrations = Enumerable.Range(1, 23).Except([5])
            .Append(25).Append(26).Append(28).Append(30).Append(31).Append(32)
    ...
    {
        // Recharacterized 2026-09-07 with SL-032.
        // Previous root: sha256:b4e098cea888de68e804c8883d030ffeba598419261e961c97726613371fe48e.
        Assert.Equal(
            "sha256:81c7c69b842771aaf8f1f678c3c4fb466ae2938ae6085c6f0ce0e70cb44bab7e",
